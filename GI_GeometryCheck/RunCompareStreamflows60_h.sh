...
#SBATCH -o /scratch/js4yd/GI_RandomSeedEval910/Compareh60.out
...
#7: File end name
Rscript /sfs/lustre/bahamut/scratch/js4yd/GI_RandomSeedEval910/CompareGIStreamflows_h.R '30' '/scratch/js4yd/GI_RandomSeedEval910/' 'RHESSys_Baisman30m_g74' '100' '2004-10-01' '201' '60'