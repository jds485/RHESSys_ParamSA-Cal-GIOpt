...
#SBATCH -o /scratch/js4yd/GI_RandomSeedEval910/RHESSysRuns/output/Run80_%a.out
...
cp "$BASEDIR"/'Test80.txt' "$PROJDIR"/"$RHESSysNAME"/
singularity exec "$SINGIMAGE"/rhessys_v3.img Rscript "$PROJDIR"/GIAllocation/AllocateGI_910_Rivanna.R "$i" 'MaxGI30m910.csv' 'lulcFrac30m.csv' "$PROJDIR"/"$RHESSysNAME" '2' '3' 'lulcFrac30m_GI.csv' '9' '900' 'Test80.txt'
rm "$PROJDIR"/"$RHESSysNAME"/'Test80.txt'
