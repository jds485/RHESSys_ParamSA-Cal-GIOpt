...
#Row to read in
fdInd = as.numeric(arg[1])
fd = as.numeric(read.table(arg[10], header = TRUE, sep = '\t', stringsAsFactors = FALSE)[fdInd,])
...
#Round to 6 digits of precision to match how it was run in optimization
HillPct = round(HillPct,6)
