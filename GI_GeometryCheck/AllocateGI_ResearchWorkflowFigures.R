...
#Min low flood----
#Set GI coverage proportion
HillPct = matrix(rep(0.1,18), nrow = 6, ncol = 3)
...
png('GI_pctMax_MinLowFlood.png', res = 300, units = 'in', width = 5, height = 5)
par(mar= c(0,0,0,0))
#All cells
...
#Max Flood----
#Set GI coverage proportion
HillPct = matrix(rep(0.8,18), nrow = 6, ncol = 3)
...
png('GI_pctMax_MaxLowFlood.png', res = 300, units = 'in', width = 5, height = 5)
par(mar= c(0,0,0,0))
#All cells
plot(CellGrid, col = 'white')
#All possible GI locations
