...
#SBATCH -o /scratch/js4yd/Bais910Hill30mDREAMzs-10Ch/RHESSysDREAM-A10-s400.out   # Name of the output file (eg. myMPI.oJobID)
...
##### 9 is Different than RunRHESSysDREAMCal-10Ch_rr_arg.sh#####
