#!/bin/bash
#SBATCH -D /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_Syn/
#SBATCH -o /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_Syn/Run_MoveOpt-Syn.out
...
cd /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_Syn/

#Directory to move into (must already exist with RHESSysRuns/output directory)
VAL='/nv/vol288/quinnlab-value/js4yd/Bais910Hill30mOptGI_Syn'
