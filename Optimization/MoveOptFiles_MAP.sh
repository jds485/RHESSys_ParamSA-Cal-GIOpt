#!/bin/bash
#SBATCH -D /sfs/lustre/bahamut/scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/
#SBATCH -o /sfs/lustre/bahamut/scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/Run_MoveOpt-Syn.out
...
cd /scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/

#Directory to move into (must already exist with RHESSysRuns/output directory)
VAL='/nv/vol288/quinnlab-value/js4yd/Bais910Hill30mOptGI_MAP'
