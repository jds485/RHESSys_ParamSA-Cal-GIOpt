#!/bin/bash
#SBATCH -D /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_MORO/
#SBATCH -o /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_MORO/Run_MoveOpt-MORO.out
...
cd /sfs/lustre/bahamut/scratch/js4yd/Bais910Hill30mOptimizeGI_MORO/

#Directory to move into (must already exist with RHESSysRuns/output directory)
VAL='/nv/vol288/quinnlab-value/js4yd/Bais910Hill30mOptGI_MORO'
