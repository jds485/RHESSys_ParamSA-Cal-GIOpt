...
#SBATCH -o /scratch/js4yd/Bais910Hill30mOptimizeGI_MORO/RHESSysRuns/output/RunMOROSyn_%a.out
...
singularity exec "$SINGIMAGE"/rhessys_v3.img Rscript "$PROJDIR"/GIAllocation/AllocateGI_910_Rivanna_Syn.R "$i" 'MaxGI30m910.csv' 'lulcFrac30m.csv' "$PROJDIR"/"$RHESSysNAME" '2' '3' 'lulcFrac30m_GI.csv' '9' '900' '/scratch/js4yd/Bais910Hill30mOptimizeGI_MORO/GInolic_IDs.referenceDVO'
...
REP=1
seed2=157
Rscript ../GIAllocation/CalcObjsSyn.R "$i" '0' '' ./output "$seed2" ./defs/Params_logLQ_0.csv ./lulcFrac30m_GI.csv "$REP"
