...
#SBATCH -o /scratch/js4yd/Bais910Hill30mOptGI_MOROMinMax/RHESSysRuns/output/RunMOROMinMaxSyn_%a.out
...
BASEDIR='/scratch/js4yd/Bais910Hill30mOptGI_MOROMinMax'
#RLIBPATH='/home/js4yd/R/x86_64-pc-linux-gnu-library/3.5'
RLIBPATH='/project/quinnlab/js4yd/homeFiles/R/x86_64-pc-linux-gnu-library/3.5/'
RLIBPATHGOOLF='/home/js4yd/R/goolf/3.5'
...
PROJDIR="$BASEDIR"/RHESSysRuns/Run"$i"_Syn
...
cp "$BASEDIR"/GIAllocation/CalcObjsSyn.R "$PROJDIR"/GIAllocation
...
singularity exec "$SINGIMAGE"/rhessys_v3.img Rscript "$PROJDIR"/GIAllocation/AllocateGI_910_Rivanna_Syn.R "$i" 'MaxGI30m910.csv' 'lulcFrac30m.csv' "$PROJDIR"/"$RHESSysNAME" '2' '3' 'lulcFrac30m_GI.csv' '9' '900' '/scratch/js4yd/Bais910Hill30mOptGI_MOROMinMax/GInolic_IDs.referenceDVO'
...
rm ./output/Run"$i"_Syn_basin.hourly
rm ./output/Run"$i"_Syn_basin.monthly
rm ./output/Run"$i"_Syn_basin.yearly
rm ./output/Run"$i"_Syn_hillslope.hourly
rm ./output/Run"$i"_Syn_hillslope.monthly
rm ./output/Run"$i"_Syn_hillslope.yearly
rm ./output/*.params
...
REP=1
seed2=157
Rscript ../GIAllocation/CalcObjsSyn.R "$i" '0' '' ./output "$seed2" ./defs/Params_logLQ_0.csv ./lulcFrac30m_GI.csv "$REP" "$RLIBPATHGOOLF"
