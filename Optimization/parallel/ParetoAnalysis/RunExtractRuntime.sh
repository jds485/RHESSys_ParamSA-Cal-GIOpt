...
#SBATCH -o /scratch/js4yd/Bais910Hill30mOptimizeGI_Syn/RunExtractData.out   # Name of the output file
...
module purge
module load gcc/7.1.0 openmpi/3.1.4 python/2.7.16 java/1.12.0

sh extract_runtime_metrics.sh