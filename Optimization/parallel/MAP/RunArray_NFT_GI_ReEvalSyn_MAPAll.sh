...
#SBATCH -o /nv/vol288/quinnlab-value/BaisOptMAP/Bais910Hill30mOptimizeGI_MAP/RHESSysRuns/SynEval/output/RunMAPAllSyn_%a.out
...
BASEDIR='/nv/vol288/quinnlab-value/BaisOptMAP/Bais910Hill30mOptimizeGI_MAP'
...
PROJDIR="$BASEDIR"/RHESSysRuns/SynEval/Run"$i"_MAPAllSyn
...
singularity exec "$SINGIMAGE"/rhessys_v3.img Rscript "$PROJDIR"/GIAllocation/AllocateGI_910_Rivanna_Syn.R "$i" 'MaxGI30m910.csv' 'lulcFrac30m.csv' "$PROJDIR"/"$RHESSysNAME" '2' '3' 'lulcFrac30m_GI.csv' '9' '900' '/nv/vol288/quinnlab-value/BaisOptMAP/Bais910Hill30mOptimizeGI_MAP/GInolic_IDs.referenceDVO'
...
rm ./output/Run"$i"_MAPAllSyn_basin.hourly
rm ./output/Run"$i"_MAPAllSyn_basin.monthly
rm ./output/Run"$i"_MAPAllSyn_basin.yearly
rm ./output/Run"$i"_MAPAllSyn_hillslope.hourly
rm ./output/Run"$i"_MAPAllSyn_hillslope.monthly
rm ./output/Run"$i"_MAPAllSyn_hillslope.yearly
rm ./output/*.params
