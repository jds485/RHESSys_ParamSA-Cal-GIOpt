#!/bin/bash
#SBATCH -D /nv/vol288/quinnlab-value/js4yd
#SBATCH -o /nv/vol288/quinnlab-value/Bais910Hill30mOptimizeGI_MAP/Run_JoinOptMAP.out
...
Rscript JoinOptMAP.R '/nv/vol288/quinnlab-value/Bais910Hill30mOptimizeGI_MAP/Bais910Hill30mOptimizeGI_MAP/RHESSysRuns' '/RHESSys_Baisman30m_g74' '/nv/vol288/quinnlab-value/Bais910Hill30mOptimizeGI_MAP/'