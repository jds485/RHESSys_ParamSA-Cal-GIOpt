...
source('/scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/LikelihoodFun/GL_maineqs.R')

#Read in the pre-GI streamflow in cfs units----
#Already has desired date range
Qp = read.table(paste0('/scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/obs/Q', arg[2], 'NoError.txt'), header=TRUE, sep='\t', stringsAsFactors=FALSE)

#Get conversion_b for streamflow----
world = read.csv('/scratch/jdq6nn/Bais910Hill30mOptimizeGI_MAP/RHESSys_Baisman30m_g74/worldfiles/worldfile.csv', stringsAsFactors = FALSE)
res = 30
