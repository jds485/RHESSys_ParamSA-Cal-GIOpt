...
hist(abs(DVO_MOROSyn$LowFlow - DVO_MOROSyn$LowFlowSyn)*100, breaks = seq(0,0.3,0.015)*100, xlab = 'Change from Synthetic (%)', main = 'MORO Low Flow Objective', cex.lab=1.5, cex.axis=1.5, col = 'black', border = 'gray')
lines(c(1.5,1.5), c(0,30), col = 'red', lwd=2)
dev.off()
...
hist(TreesThreshSyn$NumTrees, col = 'black', border = 'gray', breaks = seq(3500,10500,500), ylim = c(0,8), main='Number of Trees Meeting Thresholds', xlab = 'Number of Trees', cex.lab=1.5,cex.axis=1.5)
par(new=TRUE)
...
legend('topright', legend = c('Synthetic', 'MAP', 'MORO'), col = c('black', alpha.col('red',0.5), alpha.col('blue',0.5)), pch = 15)
dev.off()
...
setwd("C:\\Users\\js4yd\\OneDrive - University of Virginia\\BES_Data\\BES_Data\\RHESSysFiles\\BR&POBR\\SyntheticHill11+12")
png('ParetoSyn_ColTrees_MAP+MOROsols.png', res = 300, units = 'in', width = 6, height = 6)
plot(-DVO$Flooding*100, -DVO$LowFlow*100, col = colFun(DVO$NumTrees),
     xlim = c(0, 60), ylim=c(-100, 10), xlab = 'Flooding Reduction (%)', ylab = 'Low Flow Reduction (%)', cex.axis = 1.5, cex.lab = 1.5, main = 'Reforestation Optimization to Synthetic Truth', pch = 16)
lines(c(-110,110), c(0,0))
lines(c(-0,0), c(-120,120))
...
#Just lines
png('ParetoSyn_ColTrees_MAP+MOROsols_lines.png', res = 300, units = 'in', width = 6, height = 6)
plot(-CompromiseSynMinTrees$Flooding*100, -CompromiseSynMinTrees$LowFlow*100, col = colFun(CompromiseSynMinTrees$NumTrees),
     xlim = c(0, 60), ylim=c(-100, 10), xlab = 'Flooding Reduction (%)', ylab = 'Low Flow Reduction (%)', cex.axis = 1.5, cex.lab = 1.5, main = 'Reforestation Optimization to Synthetic Truth', pch = 16)
lines(c(-110,110), c(0,0))
lines(c(-0,0), c(-120,120))
...
png('ParetoSyn_ColTrees_MAP+MOROsols_linesThresh.png', res = 300, units = 'in', width = 6, height = 6)
plot(-CompromiseSynMinTrees$Flooding*100, -CompromiseSynMinTrees$LowFlow*100, col = colFun(CompromiseSynMinTrees$NumTrees),
     xlim = c(0, 60), ylim=c(-100, 10), xlab = 'Flooding Reduction (%)', ylab = 'Low Flow Reduction (%)', cex.axis = 1.5, cex.lab = 1.5, main = 'Reforestation Optimization to Synthetic Truth', pch = 16)
lines(c(-110,110), c(0,0))
lines(c(-0,0), c(-120,120))
