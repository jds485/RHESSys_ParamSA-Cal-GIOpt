...
#SBATCH -o /scratch/js4yd/MorrisSA/SAmetrics/output/Run_%a.out
...
Rscript "$INDIR"/ExtractSAtrajectories.R "$SLURM_ARRAY_TASK_ID" "$OUTDIR" "/scratch/js4yd/MorrisSA/SAmetrics/EEs_All_Setup.RData"
