...
#SBATCH -o /scratch/js4yd/MorrisSA/SAmetrics/Run_JoinSAbm.out
...
Rscript JoinSAtrajectories_Meds_b.R '/scratch/js4yd/MorrisSA/SAmetrics/SAdata/' "/scratch/js4yd/MorrisSA/SAmetrics/MorrisSamples_BeforeProcessing.csv" '/scratch/js4yd/MorrisSA/SAmetrics/'