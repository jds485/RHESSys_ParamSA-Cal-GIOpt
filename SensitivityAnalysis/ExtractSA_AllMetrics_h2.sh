...
#SBATCH -o /scratch/js4yd/MorrisSA/SAmetrics/output/Run_2h%a.out
...
Rscript "$INDIR"/ExtractSAtrajectories_AllMetrics_h2.R "$SLURM_ARRAY_TASK_ID" "$OUTDIR" "/scratch/js4yd/MorrisSA/SAmetrics/EEs_All_Setup_paperh2.RData"
