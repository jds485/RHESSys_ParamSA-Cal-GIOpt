...
#SBATCH -o /scratch/js4yd/LikelihoodAnalysis/Flow_MLEfits.out   # Name of the output file (eg. myMPI.oJobID)
...
#SBATCH -t 05:00:00       					# Run time (hh:mm:ss) - up to 36 hours
...
#mpirun python Flow_MLEfits.py '518' 'BaismanStreamflow_Cal.txt' 'SAResults_BasinStreamflow_p4_Reordered_Add5_Likes.txt' '20' 'SA_Params_logL_Baisman'                        