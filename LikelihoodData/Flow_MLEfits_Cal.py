...
Qdf = pd.DataFrame(columns=['Replicate', 'Chain', 'beta','xi','sigma_0','sigma_1','phi_1','mu_h','logL','SSEdBC','SSEd','SSEw','SSEm','SSEa','NSEdBC','NSEd','NSEw','NSEm','NSEa','LNSEd','LNSEw','LNSEm','LNSEa','pBias','success','mess'])
...
#Add BC transformed daily flows
cTrueQ['BCdFlow'] = TrueQ_BC
cSimQ['BCdFlow'] = SimQ['streamflow']
