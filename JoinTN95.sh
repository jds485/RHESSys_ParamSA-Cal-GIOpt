...
Rscript TNFileJoining_Hill95.R "/scratch/js4yd/MorrisSA/TNprocessing/" 'DateColumnNames.txt' 'SAResults_HillStreamflow_p6_t.txt' '/scratch/js4yd/MorrisSA/TNprocessing/TNdata/' "TNSAreps_Hill95_All.RData" 'SAResults_HillTN95_p3_All.txt'